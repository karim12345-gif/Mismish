...
async function main() {
  ...
  // "Available now" — 2-hour window, already open
  const now1  = { s: h(-0.25), e: h(1.75) };  // 15 min ago → +1h45
  const now2  = { s: h(-0.5),  e: h(1.5)  };  // 30 min ago → +1h30
  const now3  = { s: h(-0.25), e: h(1.75) };

  // "Later today" — opens in ~1h, 2-hour window
  const later = { s: h(1),     e: h(3)    };

  // "Tomorrow" — 2-hour window starting in ~22h
  const tmr   = { s: h(22),    e: h(24)   };
  ...
  const vendorData = [
    ...
    // Additional Riyadh vendors for realistic map density
    {
      ...
      name: "Tahlia Café",
      description: "Trendy café on Tahlia Street.",
      imageUrl:
        "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800",
      category: "Café",
      latitude: 24.6928,
      ...
      listings: [
        {
          ...
          description: "Assorted pastries from the morning batch.",
          imageUrl:
            "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800",
          price: 18,
          originalPrice: 55,
    ...
    },
    {
      ...
      listings: [
        {
          name: "Najdi Meal Box",
          description: "Traditional Najdi rice and lamb.",
          imageUrl:
            "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800",
          price: 28,
          originalPrice: 80,
      ...
      listings: [
        {
          ...
          description: "Assorted Arabic sweets and kunafa.",
          imageUrl:
            "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=800",
          price: 22,
          originalPrice: 65,
      ...
      listings: [
        {
          ...
          description: "3-4 slices of assorted pizzas.",
          imageUrl:
            "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=800",
          price: 20,
          originalPrice: 60,
      ...
      listings: [
        {
          ...
          description: "Generous portions of mandi rice and meat.",
          imageUrl:
            "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800",
          price: 32,
          originalPrice: 90,
    ...
    },
    {
      ...
      latitude: 24.7447,
      longitude: 46.6812,
      address: "Prince Turki Rd, North Riyadh",
      listings: [
        {
          name: "Shawarma Bag",
          description: "3 shawarma wraps with garlic sauce.",
          imageUrl:
            "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=800",
          price: 20,
          originalPrice: 55,
